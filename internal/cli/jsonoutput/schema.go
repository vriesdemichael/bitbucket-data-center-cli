			...
			"error": map[string]any{
				...
				"properties": map[string]any{
					...
					"details": map[string]any{
						"description": "Machine-readable fields to act or branch on, keyed by name, rather than words to match in the message. Absent when there are none. A failure Bitbucket answered carries upstreamStatus, and upstreamException when Bitbucket named the exception.",
						"type":        "object",
