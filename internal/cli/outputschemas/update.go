...
func updateSchemas() map[string]map[string]any {
	return map[string]map[string]any{
		"output.update.schema.json": jsonoutput.EnvelopeSchemaFor(
			...
			"bb update output",
			"JSON output schema for `bb update --json`. Data describes the current version, latest release, selected artifact, checksum and signature status, the trust material verification used, and whether an update was applied or only previewed.",
			map[string]any{
				"type":                 "object",
				...
				"properties": map[string]any{
					...
					"signature_bundle_asset_name": map[string]any{"type": "string"},
					"signature_verified":          map[string]any{"type": "boolean"},
					"signature_skipped":           map[string]any{"type": "boolean"},
					"signature_identity":          map[string]any{"type": "string"},
					"signature_issuer":            map[string]any{"type": "string"},
					"transparency_log_verified":   map[string]any{"type": "boolean"},
					"trust_source":                map[string]any{"type": "string"},
