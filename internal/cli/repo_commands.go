...
func newRepoSettingsCommand(options *rootOptions) *cobra.Command {
	...
	permissionsCmd.AddCommand(newRepoPermissionSubjectCommand(options, &repositorySelector, userPermissionSubject()))
	permissionsCmd.AddCommand(newRepoPermissionSubjectCommand(options, &repositorySelector, groupPermissionSubject()))
...
func newRepoPermissionsCommand(options *rootOptions) *cobra.Command {
	...
	addRepoPermissionAliases(permissionsCmd, options, &repositorySelector)
