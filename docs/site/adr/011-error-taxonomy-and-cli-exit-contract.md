...
A status that arrived is an answer, whatever became of the body behind it. A reply cut short after 201 says the change was applied, and is reported as applied and not to be sent again; one cut short after a 4xx says it was refused. Only a mutation with no status at all is unknown.
