...
|---|---:|---|
| `move-to-live` | 65 | write the live test, then delete the mock |
...
| `internal/cli/cmd/auth/gpg_test.go` | 3 | 1 | 2 | 0 | 0 |
...
| `internal/services/project/service_test.go` | 4 | 0 | 1 | 2 | 1 |
...
| `internal/cli/commit_test.go` | 2 | 0 | 1 | 1 | 0 |
...
| `internal/cli/cmd/admin/admin_test.go` | 1 | 0 | 1 | 0 | 0 |
...
| `internal/cli/cmd/reviewergroup/reviewer_group_test.go` | 1 | 0 | 1 | 0 | 0 |
